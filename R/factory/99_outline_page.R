...
sec('McVay (offense)',
    ...
    note('The single-game version, film-ready: at Seattle, week 13 of 2022-23, he showed the same look 28 times (11 personnel, 2x2, under center) and called <b>15 different plays</b> out of it; every snap is tabled with quarter and clock for clipping. Current-era alternate: week 9 of 2025-26 vs New Orleans, the 13-personnel under-center look, 20 snaps, 11 plays. He motions on <b>62% of snaps</b> (4th of 37, league median 46%), so the motion-effect comparison is his own other 38%.'),
    fig(file.path(OLD,'one_look_one_game.png'),
        'Film-card table of 28 snaps of one McVay look in one game, 15 distinct plays with quarter, clock and result',
        'One game, one look, fifteen plays. Built by R/44.'),
