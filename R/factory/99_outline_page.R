...
sec('Defense: showing one coverage and playing another',
    ...
    note('Michael&rsquo;s outside numbers on Seattle, checked stat by stat: they show two-high on <b>85.5%</b> of dropbacks, second in the league behind Philadelphia, not first, and his league average runs ten points low (different charting source). Cover 3 is 16th, not 31st. The keeper stat the check uncovered: they show two-high at 85.5% and <b>play it at 56.2%</b>, a 29-point spin-down, sixth-most rotation in football. Seattle advertises two-high and then leaves.'),
    fig(file.path(OLD,'sea_twohigh.png'),
        'Verification chart pairing the claimed Seahawks pre-snap numbers against SumerSports measurements',
        'His numbers against Sumer&rsquo;s, stat by stat. Built by R/20.')),
