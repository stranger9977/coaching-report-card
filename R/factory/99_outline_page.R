...
sec('Where can play-calling obviously be improved?',
    ...
    fig(file.path(FIG,'leaks.png'),
        ...
        'Every pass-versus-run comparison here is made inside a matched cell of down, distance, field position and score, so it is like for like. Passing wins in 95% of those cells. Biggest on 2nd and 8-10 at +0.27 EPA. No point value is quoted, because the marginal run does not become an average pass.')),
