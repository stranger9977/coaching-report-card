...
sec('McVay (offense)',
    ...
    fig(file.path(OLD,'mcvay_formula.png'),
        'Four stacked strips: picture variety, personnel holding, play variety inside stretches, and motion effect, with McVay highlighted on each',
        'The 25-plays-like-250 composite. Each panel replots its source script&rsquo;s shipped numbers. Built by R/42.'),
