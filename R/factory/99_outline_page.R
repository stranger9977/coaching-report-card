...
sec('McVay (offense)',
    ...
    note('Players and coordinators are quoted saying he "makes 25 plays seem like 250." The four measurements above now live in one composite for the camera: 5th-fewest pictures, personnel held 84% (1st), 4th-most play variety inside the held stretches, and the league&rsquo;s largest interval-backed motion effect on run/pass guessability. The twist to say out loud: his static pictures tip the play MORE than anyone&rsquo;s; the disguise is what moves inside them, not the picture count.'),
